...
SELECT * FROM ALL_SEQUENCES WHERE SEQUENCE_NAME='CACTUS_SAFI.SEC_CLI_WEB_EXTERNO';
...
GRANT SELECT,INSERT,UPDATE,DELETE ON CACTUS_SAFI.CLI_DOCUMENTO_DIRECT TO PROSIS_FIN; 
