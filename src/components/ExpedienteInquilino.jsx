  ...
  const handleDescargarClick = () => {
    ...
    pdf.text(
      `Nombres: ${capitalizeFirstLetter(
        expedienteSelect?.des_nombres?.trim()
      )}`,
      startX,
    ...
    pdf.text(
      `Dni: ${expedienteSelect?.dni?.trim()}`,
      startX,
      calculateYPosition(4)
    );
    pdf.text(
      `Sexo: ${expedienteSelect?.des_genero?.trim()}`,
      startX,
      calculateYPosition(5)
    );
    pdf.text(`Fecha de Nacimiento: 2023-08-07`, startX, calculateYPosition(6));
    pdf.text(
      `Deparatamento de nacimiento: ${capitalizeFirstLetter(
    ...
    pdf.text(
      `Grado de Instruccion: ${capitalizeFirstLetter(
    ...
    pdf.text(
      `Estado Civil: ${capitalizeFirstLetter(
    ...
    pdf.text(
      `Departamento de Domicilio: ${capitalizeFirstLetter(
    ...
    pdf.text(
      `Provincia de Domicilio: ${capitalizeFirstLetter(
    ...
    pdf.text(
      `Distrito de Domicilio: ${capitalizeFirstLetter(
    ...
    pdf.text(
      `Dirección de Domicilio: ${capitalizeFirstLetter(
    ...
    pdf.setTextColor("#000000"); // Color negro
    pdf.text(
      `Número de Teléfono: ${props.padron.data.num_telefono}`,
      startX,
      calculateYPosition(15)
    );
    pdf.text(
      `Correo Electrónico: ${props.padron.data.des_correo}`,
      startX,
    ...
    pdf.setTextColor("#000000"); // Color negro
    pdf.text(
      `Puesto a Revisar: ${inmuebleSelect?.numPuesto}`,
      startX,
    ...
    pdf.text(
      `Direccion: ${inmuebleSelect?.des_direccion}`,
      startX,
      calculateYPosition(20)
    );
    pdf.text(
      `Giro: ${inmuebleSelect?.des_giro}`,
      startX,
      calculateYPosition(21)
    );
        ...
        <div>
          <div>
            ...
            <div
              ...
              className="title-descargar-expediente-inquilino"
            >
            ...
            <div className="container-combo-socio">
              ...
              >
                {props.inmueblesinfo.map((inmueble) => (
                  <option
                    key={inmueble.id}
                    value={`${inmueble.numPabellon}-${inmueble.numPuesto}`}
                  >
              ...
              <div className="col-md-3">
                ...
                <ModalImagesConglomerado
                  ...
                  components={[
                    <ImageUploader
                      info={ModeloProps1}
                      documentoPropietario={props.padron.data.documentoInquilinoEntities.find(
                        (item) => item.desTipoDoc === "ConatratoAlquiler"
                      )}
                    ...
                    <ImageUploader
                      info={ModeloProps2}
                      documentoPropietario={props.padron.data.documentoInquilinoEntities.find(
                        (item) => item.desTipoDoc === ModeloProps2.tipDoc
                      )}
                      api={`${serverURL}/Inquilino/Upload-info-inquilino`}
                      dataPropietario={props.padron.data}
