...
const FormRegistroInquilinos = ({ RefrescarInformacion, clickR, setClickR,EstadoGlobal,dataPuestos,dataPabellonPuesto }) => {
   ...
   const elementosFiltrados = dataPabellonPuesto.map(item => {
                    ...
                    <div className="form form-registro-padron-inquilino">
                        ...
                        <form className="form" onSubmit={enviarDatos}>
                                ...
                                <div className="row" style={{ width: '100%' }}>
                                    ...
                                    <div className="col-md-4">
                                        ...
                                        <div className="title-nuevo-inquilino-registro-formpadron-orange title-nuevo-inquilino-registro-formpadron-black-div">
                                            Pabellon  {!puestoValido && (
                                                <span className="error-message-from-prop ">*No válido</span>
                                            )}
                                        </div>
                                        <Select
                                            name="des_estado_civil"
                                            value={{ value: datos.inmuebleEntities[0].numPabellon, label: datos.inmuebleEntities[0].numPabellon }}
                                            onChange={handlePabellon}
                                            options={dataPuestos}
                                            styles={customStyles}
                                            />
                                        <div div className="title-nuevo-inquilino-registro-formpadron-orange title-nuevo-inquilino-registro-formpadron-black-div">
                                            Giro
                                        </div>
                                        <input
                                            type="text"
                                    ...
                                    <div className="col-md-4">
                                        ...
                                        <br />
                                        <div className="title-nuevo-inquilino-registro-formpadron-green title-nuevo-inquilino-registro-formpadron-black-div">
                                            Puesto{!pabellonValido && (
                                                <span className="error-message-from-prop ">*No válido</span>
                                            )}
                                        </div>
                                        <Select
                                            name="numPuesto"
                                            value={{ value: datos.inmuebleEntities[0].numPuesto, label: datos.inmuebleEntities[0].numPuesto }}
                            ...
                            <div className="btn-register-padron-socios-info" style={{ width: `100%` }}>
                                ...
                                <button type="submit" class="btn-enviar-carga-masiva-directivos">Registrar Inquilino
                                </button>
