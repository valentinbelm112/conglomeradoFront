    ...
    <div className="container-expediente-socio">
      ...
      <div className="row">
        <div className="col-md-4">
          ...
          <div className="Partida-registral-socio-title-p">puesto: #### -</div>
          <div className="Partida-registral-socio-title-p">puesto: ####</div>
          <div className="container-expediente-radio-button">
            ...
            <label
              ...
              className="container-expediente-contactChoice1-socio"
            >
              Socio
            </label>
            <input
        ...
        <div className="col-md-8  container-right-info-inmebles-doc">
          ...
          <div className="row container-infor-personal-inmuebles">
            <div className="col-7">
              ...
              <div className="row container-dominio-acciones">
                <div className="col-md-12">
                  ...
                  <div className="title-tipo-dominio-p">##############</div>
                </div>
              </div>
            </div>
            <div className="col-5">
            ...
            <div className="title-cotitular-conyugue-p">Co-Propietario |</div>
