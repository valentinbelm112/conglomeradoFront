...
const ListExpedientesInquilino=()=>{
    ...
    const {dataExpediente,isLoading,dataDetallePropietario,sociosPabellon,expedienteConyugue,propietario,pabellones,inmueblesinfo}=useGetExpedienteInquilino(`${serverURL}/cliente/consultar-reniec`,id,id2);
   ...
   if(isLoading ){
    ...
    return (
        ...
        <div className="container-Sidebar-view-directivo">
        {
           ...
           <ExpedienteInquilino expediente={dataExpediente} expedienteCony={expedienteConyugue} padron={dataDetallePropietario} propietario={sociosPabellon} cambiarEstado={cambiarEstadoPadre}  nombreExpedienteProp={propietario} pabellones={pabellones} inmueblesinfo={inmueblesinfo} />
          </div>
          </div>
    );
}
