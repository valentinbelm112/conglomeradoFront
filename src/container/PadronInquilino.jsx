          ...
          <div className="title-Inquilinos-registrados">
            ...
            <div className="table-responsive container-list-table-registro-inquilino">
                <table class="table table-bordered table-condensed table-hover table-striped">
                    <thead>
                        <tr >
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px',color:'#56688a' }}>
                            ...
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px',color:'#56688a'}}>Nombres Completos</th>
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px',color:'#56688a' }}>
                                <div className="container-order-a-z-inquilino">
                                    <div>
                                        DNI
                            ...
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px' ,color:'#56688a'}}>Pasaje</th>
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px',color:'#56688a' }}>Puesto</th>
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px',color:'#56688a' }} >Dirección</th>
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px',color:'#56688a' }}>Giro</th>
                            <th scope="col" style={{ backgroundColor: '#a2c8f2', padding: '8px',  borderTop: '2px solid white', borderLeft: '2px solid white', borderBottom: '2px solid white' ,whiteSpace: 'nowrap',fontSize:'12px',color:'#56688a' }}>Estado</th>
