...
delete  from CLI_CONGLOMERADO_PROP;
...
delete  from CLI_INMUEBLE_PROP;
select 
--Create table CLI_USUARIO_CGM ----
select *from CLI_INMUEBLE_socio
...
delete  from CLI_PROPIETARIO_INMUEBLE;
drop table CACTUS_SAFI.CLI_PROPIETARIO_INMUEBLE 
--Create table CLI_USUARIO_CGM ----
...
(
  ...
  des_partida_registral               VARCHAR2(50),
  num_acciones_derechos               NUMBER(10, 8),
  des_comentario                      VARCHAR2(400),
...
(
  num_documentopdf_prop            NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  des_codigo_asociacion               VARCHAR2(50),
  fec_actualizacion                   DATE,
  des_nombre_documento                VARCHAR2(200),
  des_contenido                       BLOB,
...
comment on table CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP
  is 'tabla  que contiene informacion de los documentos en formato pdf de los directivos  y propietarios.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP.num_documentopdf_prop
  is 'COLUMNA num_documentopdf_prop Especifica el identificador único de cada registro en la tabla.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP.des_codigo_asociacion
  is 'COLUMNA des_codigo_asociacion Especifica el codigo de asociacion al que pertenece el documento.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP.fec_actualizacion
  is 'COLUMNA fec_actualizacion Describe la fecha en que se realizó el registro del documento.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP.des_nombre_documento
 is 'COLUMNA des_nombre_documento Especifica el nombre del documento pdf.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP.des_contenido
 is 'COLUMNA  des_contenido contiene el contenido en codigo binario del pdf cargado.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP.des_dni
 is 'COLUMNA tip_usuario Describe el dni del propietario.';


--CREACION DE PRIMARY KEY
ALTER TABLE CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP ADD CONSTRAINT CLI_DOCUMENTOPDF_PROP_PK PRIMARY KEY(num_documentopdf_prop);

--PERMISOS SYNONYM Y GRANT 
CREATE OR REPLACE PUBLIC SYNONYM CLI_DOCUMENTOPDF_PROP FOR CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP;

GRANT SELECT,INSERT,UPDATE,DELETE ON CACTUS_SAFI.CLI_DOCUMENTOPDF_PROP TO webuser; 

--Create table CLI_DOCUMENTO_PDF fin ----


-- CREAR TABLA
create table CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO
(
  num_socio                           NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  des_codigo_socio                    VARCHAR2(50),
  des_nombres                         VARCHAR2(200),
  des_dni                             VARCHAR2(15),
  des_estado_civil                    VARCHAR2(50),
  des_dni_conyugue                    VARCHAR2(15),
  num_telefono                        NUMBER(10),
  des_correo                          VARCHAR2(50),
  des_documento_link                  VARCHAR2(100),
  des_codigo_asociacion               VARCHAR2(50),
...
-- DESCRIPCION DE LA TABLA
comment on table CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO
  is 'Tabla que contiene información de los socios.';

-- COMENTARIOS DE COLUMNAS
comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.num_socio
  is 'COLUMNA num_socio: Especifica el identificador único de cada registro en la tabla.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_codigo_socio
  is 'COLUMNA des_codigo_socio: Código único asignado a cada socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_nombres
  is 'COLUMNA des_nombres: Nombres del socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_dni
  is 'COLUMNA des_dni: Número de DNI (Documento Nacional de Identidad) del socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_estado_civil
  is 'COLUMNA des_estado_civil: Estado civil del socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_dni_conyugue
  is 'COLUMNA des_dni_conyugue: Número de DNI del cónyuge del socio (si aplica).';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.num_telefono
  is 'COLUMNA num_telefono: Número de teléfono del socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_correo
  is 'COLUMNA des_correo: Dirección de correo electrónico del socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_documento_link
  is 'COLUMNA des_documento_link: Enlace o referencia a algún documento relacionado con el socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_codigo_asociacion
  is 'COLUMNA des_codigo_asociacion: Código de asociación relacionado con el socio.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.des_estado
  is 'COLUMNA des_estado: Estado actual del socio en el sistema.';

comment on column CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO.fec_registro
  is 'COLUMNA fec_registro: Fecha de registro del socio en la base de datos.';

--CREACION DE PRIMARY KEY
ALTER TABLE CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO ADD CONSTRAINT CLI_CONGLOMERADO_SOCIO_PK PRIMARY KEY(num_socio);

--PERMISOS SYNONYM Y GRANT 
CREATE OR REPLACE PUBLIC SYNONYM CLI_CONGLOMERADO_SOCIO FOR CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO;

GRANT SELECT,INSERT,UPDATE,DELETE ON CACTUS_SAFI.CLI_CONGLOMERADO_SOCIO TO webuser;


-- CREAR TABLA
create table CACTUS_SAFI.CLI_INMUEBLE_SOCIO
(
  num_inmueble_soc                     NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  num_pabellon                         VARCHAR2(50),
  num_puesto                           VARCHAR2(50),
  des_direccion                        VARCHAR2(200),
...
-- DESCRIPCION DE LA TABLA
comment on table CACTUS_SAFI.CLI_INMUEBLE_SOCIO
  is 'Tabla que contiene información sobre los inmuebles de los socios.';

-- COMENTARIOS DE COLUMNAS
comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.num_inmueble_soc
  is 'COLUMNA num_inmueble_soc: Número de identificación único asignado automáticamente a cada inmueble. Este es el identificador principal de la tabla.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.num_pabellon
  is 'COLUMNA num_pabellon: Número de pabellón asociado al inmueble.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.num_puesto
  is 'COLUMNA num_puesto: Número de puesto asociado al inmueble.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.des_direccion
  is 'COLUMNA des_direccion: Dirección del inmueble.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.des_giro
  is 'COLUMNA des_giro: Giro del negocio asociado al inmueble.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.des_negocio
  is 'COLUMNA des_negocio: Descripción del negocio asociado al inmueble.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.des_codigo_asociacion
  is 'COLUMNA des_codigo_asociacion: Código de asociación relacionado con el inmueble.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.des_estado
  is 'COLUMNA des_estado: Estado actual del inmueble en el sistema.';

comment on column CACTUS_SAFI.CLI_INMUEBLE_SOCIO.fec_registro
  is 'COLUMNA fec_registro: Fecha de registro del inmueble en la base de datos.';
  
-- Create table CLI_DOCUMENTOPNG_PROP  -----------------------------------------------------------------------------------
create table CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO
(
   num_documento_socio           NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
   des_link_documento           VARCHAR2(200),
   des_dni                      VARCHAR2(15),
...
--DESCRIPCION DE LA TABLA
comment on table CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO
  is 'tabla  que contiene informacion de los documentos legales de los SOCIOS.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO.num_documento_socio
  is 'COLUMNA num_documento_socio Especifica el identificador único de cada registro en la tabla.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO.des_link_documento 
 is 'COLUMNA des_link_documento Especifica la URL o ruta del documento adjunto.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO.des_dni  
 is 'COLUMNA des_dni Especifica el número de DNI asociado al documento.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO.des_codigo_asoc 
 is 'COLUMNA des_codigo_asoc Especifica el código de asociación relacionado con el documento.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO.des_tipo_doc 
 is 'COLUMNA des_link_documento Especifica el tipo de documento legal (ej. Contrato, Minuta, etc.).';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO.fec_timestamp_call  
 is 'COLUMNA fec_timestamp_call Especifica la fecha y hora de registro del documento.';
comment on column CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO.num_socio  
 is 'COLUMNA num_socio Especifica el identificador único del propietario asociado al documento.';


--CREACION DE PRIMARY KEY
ALTER TABLE CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO ADD CONSTRAINT CLI_DOCUMENTOPNG_SOCIO_PK PRIMARY KEY(num_documento_socio);

--PERMISOS SYNONYM Y GRANT 
CREATE OR REPLACE PUBLIC SYNONYM CLI_DOCUMENTOPNG_SOCIO FOR CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO;

GRANT SELECT,INSERT,UPDATE,DELETE ON CACTUS_SAFI.CLI_DOCUMENTOPNG_SOCIO TO webuser; 

-- Create table CLI_DOCUMENTOPNG_PROP fin -----------------------------------------------------------------------------------


-- Create table CLI_PROPIETARIO_BAJA_DET  -----------------------------------------------------------------------------------
create table CACTUS_SAFI.CLI_SOCIO_BAJA_DET
(
   num_documento_baja              NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
--DESCRIPCION DE LA TABLA
comment on table CACTUS_SAFI.CLI_SOCIO_BAJA_DET
  is 'tabla  que contiene informacion de los documentos legales de los SOCIOS.';
comment on column CACTUS_SAFI.CLI_SOCIO_BAJA_DET.num_documento_baja
  is 'COLUMNA num_documento_baja Especifica el identificador único de cada registro en la tabla.';
comment on column CACTUS_SAFI.CLI_SOCIO_BAJA_DET.des_motivo 
  is 'COLUMNA des_motivo Especifica el motivo de la baja del socio.';
comment on column CACTUS_SAFI.CLI_SOCIO_BAJA_DET.fec_baja 
  is 'COLUMNA fec_baja Especifica la fecha de baja del socio.';
comment on column CACTUS_SAFI.CLI_SOCIO_BAJA_DET.des_obserbaciones 
   is 'COLUMNA des_obserbaciones Especifica observaciones adicionales relacionadas con la baja del socio.';
comment on column CACTUS_SAFI.CLI_SOCIO_BAJA_DET.des_link_documento 
   is 'COLUMNA des_link_documento Especifica la URL o ruta del documento adjunto relacionado con la baja del socio.';
comment on column CACTUS_SAFI.CLI_SOCIO_BAJA_DET.num_socio 
  is 'COLUMNA num_socio Especifica el identificador único del propietario asociado a la baja.';


--CREACION DE PRIMARY KEY
ALTER TABLE CACTUS_SAFI.CLI_SOCIO_BAJA_DET ADD CONSTRAINT CLI_SOCIO_BAJA_DET_PK PRIMARY KEY(num_documento_baja);

--PERMISOS SYNONYM Y GRANT 
CREATE OR REPLACE PUBLIC SYNONYM CLI_SOCIO_BAJA_DET FOR CACTUS_SAFI.CLI_SOCIO_BAJA_DET;
...
--Create table CLI_PROPIETARIO_INMUEBLE ----

create table CACTUS_SAFI.CLI_SOCIO_INMUEBLE
(
  num_socio_inmueble            NUMBER(10) GENERATED BY DEFAULT ON NULL AS IDENTITY,
  num_socio NUMBER REFERENCES CLI_CONGLOMERADO_SOCIO(num_socio),
  num_inmueble_soc NUMBER REFERENCES CLI_INMUEBLE_SOCIO(num_inmueble_soc)
                    
);


--DESCRIPCION DE LA TABLA
comment on table CACTUS_SAFI.CLI_SOCIO_INMUEBLE
  is 'Tabla que contiene información sobre el detalle del inmuebles de los propietarios.';
  
comment on column CACTUS_SAFI.CLI_SOCIO_INMUEBLE.num_socio_inmueble
  is 'COLUMNA num_socio_inmueble Número de identificación único asignado automáticamente a cada inmueble. Este es el identificador principal de la tabla.';

comment on column CACTUS_SAFI.CLI_SOCIO_INMUEBLE.num_socio
 is 'COLUMNA num_socio Número de identificación del propietario asociado a la relación. Esta columna hace referencia al campo num_propietario de la tabla CLI_CONGLOMERADO_SOCIO.';

comment on column CACTUS_SAFI.CLI_SOCIO_INMUEBLE.num_inmueble_soc
 is 'COLUMNA num_inmueble_soc Número de identificación del inmueble asociado a la relación. Esta columna hace referencia al campo num_inmueble_prop de la tabla CLI_INMUEBLE_SOCIO.';

--CREACION DE PRIMARY KEY
ALTER TABLE CACTUS_SAFI.CLI_SOCIO_INMUEBLE ADD CONSTRAINT CLI_SOCIO_INMUEBLE_PK PRIMARY KEY(num_socio,num_inmueble_soc,num_socio_inmueble);

--PERMISOS SYNONYM Y GRANT 
CREATE OR REPLACE PUBLIC SYNONYM CLI_SOCIO_INMUEBLE FOR CACTUS_SAFI.CLI_SOCIO_INMUEBLE;

GRANT SELECT,INSERT,UPDATE,DELETE ON CACTUS_SAFI.CLI_SOCIO_INMUEBLE TO webuser;

--fin Create table CLI_PROPIETARIO_INMUEBLE ----
